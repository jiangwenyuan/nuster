...
nst_dict_entry_t *
nst_dict_set2(nst_dict_t *dict, nst_key_t *key, nst_http_txn_t *txn, nst_rule_t *rule, int pid) {
...
int
nst_dict_set_from_disk2(nst_dict_t *dict, hpx_buffer_t *buf, hpx_ist_t host, hpx_ist_t path,
        nst_key_t *key, char *file, char *meta) {
