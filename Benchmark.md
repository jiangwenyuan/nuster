...
For those super impatient, you can see the full results [here](#results)
...
and cache servers nuster/nginx/varnish on server130.
...
* 12 cores
  * reached the max throughput when requesting files bigger than 256bytes(see [Raw output](#raw-output))
