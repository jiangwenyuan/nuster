...
------ | -------------- | --------        | --------                    | -----
master |                |                 |                             | maybe broken
H1.8.x | 2.0.8.18       | [2019-04-24][3] | [nuster-2.0.9.18.tar.gz][4] | stable: cache, nosql, http2
H1.7.x | 1.0.2.17       | [2018-10-05][5] | [nuster-1.0.2.17.tar.gz][6] | stable: cache only
disk   |                |                 |                             | disk persistence
sync   |                |                 |                             | replication

[1]:https://github.com/jiangwenyuan/nuster/releases/tag/v2.0.9.18
[2]:https://github.com/jiangwenyuan/nuster/releases/download/v2.0.9.18/nuster-2.0.9.18.tar.gz
[3]:https://github.com/jiangwenyuan/nuster/releases/tag/v2.0.9.18
[4]:https://github.com/jiangwenyuan/nuster/releases/download/v2.0.9.18/nuster-2.0.9.18.tar.gz
